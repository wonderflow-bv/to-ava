...
const sourceCodeComplexInput7 = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/complex-test-7-input.spec.js'), { encoding: 'utf8' })
const sourceCodeComplexOutput7 = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/complex-test-7-output.spec.js'), { encoding: 'utf8' })
