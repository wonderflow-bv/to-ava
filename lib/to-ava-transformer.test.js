...
const sourceCodeComplexInput10 = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/complex-test-10-with-multiple-test-cases-and-before-each-input.spec.js'), { encoding: 'utf8' })
const sourceCodeComplexOutput10 = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/complex-test-10-with-multiple-test-cases-and-before-each-output.spec.js'), { encoding: 'utf8' })

const sourceCodeComplexInput11 = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/complex-test-11-with-each-method-input.spec.js'), { encoding: 'utf8' })
const sourceCodeComplexOutput11 = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/complex-test-11-with-each-method-output.spec.js'), { encoding: 'utf8' })

const sourceCodeComplexInput12 = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/complex-test-12-with-each-method-including-strings-input.spec.js'), { encoding: 'utf8' })
const sourceCodeComplexOutput12 = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/complex-test-12-with-each-method-including-strings-output.spec.js'), { encoding: 'utf8' })
...
const sourceCodeSimpleJasminePropertyAssignmentInput = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/simple-jasmine-property-assignment-1-input.spec.js'), { encoding: 'utf8' })
const sourceCodeSimpleJasminePropertyAssignmentOutput = require('fs').readFileSync(path.resolve(__dirname, '../fixtures/simple-jasmine-property-assignment-1-output.spec.js'), { encoding: 'utf8' })
...
testChanged(sourceCodeComplexInput10, sourceCodeComplexOutput10)
testChanged(sourceCodeComplexInput11, sourceCodeComplexOutput11)
testChanged(sourceCodeComplexInput12, sourceCodeComplexOutput12)
testChanged(sourceCodeSimpleJasminePropertyAssignmentInput, sourceCodeSimpleJasminePropertyAssignmentOutput)
