...
function removeGlobalJasmineAssignments (root, j) {
...
module.exports = (fileInfo, api) => {
  ...
  describeExpressions
    .forEach(c => {
      // new
      let call = c.get('expression')
      let param = call.get('arguments', 0)
      // end new
  ...
  removeGlobalJasmineAssignments(root, j)
